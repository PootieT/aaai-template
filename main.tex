...
When we plot the size of plateau of the zerocost domains just like in
\refig{plateau}, the trend of large plateau becomes universal among
instances. In cost-minimization problems, the search strategy within
plateau becomes much more important than in the
runtime-minimization instances.
