...
It shows that the diversity in the open list remains high in \*a*, while it quickly decreases in $A^*$. It indicates that the expansion is done evenly on various kinds of nodes, rather than in a biased manner that the expansion is focused on a particular set of nodes. \todo{of course, the real figure should not be an ascii art!}
