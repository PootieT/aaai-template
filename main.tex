...
In \pddl{openstacks} and \pddl{Woodworking-cut}, we observed
...
\begin{figure}[tb]
 ...
 \pddl{Openstacks} p10 (left),
 \pddl{Woodworkin-cut} p04 (center) and
 \pddl{psr-small-open} p48 instances (right) using
