...
Recently, \citeauthor{vallati2015effective} showed that the performance of tie-breaking
strategies in satisficing planning was significantly affected by the ordering of actions, propositions, and objects in the PDDL input files (\citeyear{vallati2015effective}).
...
Thus, it is possible for the results to be affected by how the actions are
ordered, even if the fundamental domain structures are the same.
In Fast Downward, it becomes a problem of action names because it
