...
\todo[Using a XXXXX statistical significance testing]{}, there are no
...
\begin{figure}[tb]
 ...
 \caption{Experiments
 comparing the coverages of 7 configurations. For the space reason, we omitted those
...
\begin{figure}[tb]
 \centering
 \relsize{-2}
 \includegraphics{tables/aaai16-30min/zerocost/evaluated-nokey-lmcut_ld_random-lmcut_ldrd_random.pdf}
 \includegraphics{tables/aaai16-30min/zerocost/evaluated-nokey-lmcut_rd_random-lmcut_ldrd_random.pdf}
