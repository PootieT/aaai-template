...
The coverage results are shown in \reftbl{actionordering-robustness} (We
also included the original 10 runs in \reftbl{depth}).
We analysed the results of $[h,\rd,\ro]$ using statistical methods
in order to see if any result of 4 set of differently reordered domains
have the significantly dominating average coverages than the others.
