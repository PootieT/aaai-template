...
because NNs do not have strong guarantees on the learned results.
% 
Although the SAE outputs a highly accurate reconstruction of the input,
...
While this property has not been considered as an issue in the machine learning community because it does not affect the reconstruction accuracy,
...
% 
ZSAE resulted in a smaller node expansion in 109 out of 149 instances solved by both SAE and ZSAE,
and in a shorter runtime in 119 out of 149 instances (about 4/5 of the instances).
% ???
