...
The second contribution of this paper is the formal analysis comparing
...
$u$ is a uniform random sample between 0 and 1. %$0\leq u \leq 1$
...
(e.g. in \refig{unstable}, the pixel values in the output is different from the input, but we cannot tell the difference),
...
(See supplement \refsec{gumbel-softmax-theory} for the more rigorous discussion.)
...
The proposed method has some similarities to the $\ell_1$ regularization
...
Network details are in the supplement (\refsec{network-implementation}).
...
MNIST     & 8.4e-2 & 8.6e-3 & \textbf{3.7e-6} & 5.3e-2 & 2.2e-4 & \textbf{1.1e-7} & $<$1e-4 &$<$1e-4 &$<$1e-4 &$<$1e-4 &$<$1e-4 &\uline{9.1e-3}  & 100 & 51          & 1000 & 68   & 18.4   \\ 
...
Spider    & 8.5e-4 & 4.9e-4 & \textbf{6.3e-6} & 2.3e-4 & 4.2e-4 & \textbf{7.3e-7} & 2.7e-4  &2.2e-4  &3.1e-4  &2.8e-4  &$<$1e-4 &\uline{2.8e-2}  & 100 & 49          & 1000 & 200  & 18.4   \\ 
LightsOut & 9.0e-3 & 2.0e-4 & \textbf{3.9e-6} & 8.1e-3 & 1.4e-4 & \textbf{7.5e-6} & $<$1e-4 &$<$1e-4 &$<$1e-4 &$<$1e-4 &2.9e-4  &{2.8e-4}        & 100 & \textbf{16} & 1000 & 66   & 16     \\ 
Twisted   & 1.0e-2 & 7.1e-4 & \textbf{5.1e-6} & 1.0e-2 & 4.5e-4 & \textbf{1.6e-7} & $<$1e-4 &$<$1e-4 &$<$1e-4 &$<$1e-4 &$<$1e-4 &\uline{5.7e-3}  & 100 & \textbf{16} & 1000 & 49   & 16     \\ 
\end{tabular}
\end{adjustbox}
