...
for the latent propositions which guides the training toward sparserl, disentangled propositional representation.
We empirically show that this simple regularization reduces the effect of meaningless propositions
