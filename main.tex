...
Technically, they are trained by backpropagation so as to minimize the reconstruction loss, the distance between the input and the output measured by Euclidean distance or binary cross entropy.
...
When the probabilistic distribution of the encoder is a discrete distribution such as the Bernoulli distribution, VAE obtains a discrete latent representation of the data.
...
Technically, in the discrete case, the encoder's distribution is approximated by its continuous relaxation called Gumbel-Softmax distribution~\cite{jang2016categorical} in order to apply the reparameterization trick.
...
\begin{align*}
 ...
 =                        & \brackets{\text{\small vanilla SAE loss}} + \alpha \sum_n q(b_n=1 \mid x_i)
\end{align*}
...
(Implementation method in the supplement, \refsec{zsae-implementation}.)

%% This paragraph is unnecessary
% This technique alters $p_a(b)$, the target distribution of GS-VAE.
% Recall that, in GS-VAE, $p_a(b_n) = \mathrm{Bern}(0.5)$,
...
(See supplement \refsec{pruning-implementation} for implementation details.)
...
See supplements for visual examples (\refig{fig:mnist}).
...
(see supplement \reftbl{tab:variance-stochastic} for the comparison).
...
\begin{table*}[tbp]
 ...
 \begin{tabular}{|r|*{18}{c|}}
       & \multicolumn{7}{c|}{Mean variance over bits (with noisy images)}
       % & \multicolumn{4}{c|}{True ratio}
       & \multicolumn{6}{c|}{Mean Square Error (MSE)}
       & \multicolumn{4}{c|}{Effective bits}
       & Optimal
  \\
$N=$ & 36 & \multicolumn{3}{c|}{100} & \multicolumn{3}{c|}{1000}
  ...
  & Encoding
  \\
domain    &SAE     & NG-SAE   & SAE      & ZSAE              & NG-SAE   & SAE      & ZSAE              & SAE      & ZSAE    & SAE     & ZSAE    & SAE    & ZSAE   & SAE & ZSAE        & SAE  & ZSAE & Length \\ 
MNIST     &1.80E-04& 8.49E-02 & 8.60E-03 & \textbf{4.50E-07} & 5.32E-02 & 2.25E-04 & \textbf{7.82E-06} & 1.97E-07 &6.07E-07&8.33E-11  &2.51E-08 &2.70E-14&\uline{9.12E-03}& 100 & 51          & 1000 & 68   & 18.4   \\ 
Mandrill  &2.93E-04& 1.19E-03 & 8.30E-04 & \textbf{0}        & 4.26E-04 & 2.51E-04 & \textbf{2.89E-08} & 3.00E-04 &2.27E-04&2.18E-04  &2.76E-04 &2.05E-04&{3.20E-04}& 100 & 46          & 1000 & 182  & 18.4   \\ 
Spider    &5.80E-06& 8.53E-04 & 4.91E-04 & \textbf{2.90E-06} & 2.32E-04 & 4.26E-04 & \textbf{4.19E-04} & 2.71E-04 &2.43E-04&3.14E-04  &5.21E-04 &1.42E-09&\uline{2.80E-02}& 100 & 49          & 1000 & 200  & 18.4   \\ 
LightsOut &2.55E-06& 9.01E-03 & 2.01E-04 & \textbf{7.92E-07} & 8.13E-03 & 1.42E-04 & \textbf{1.43E-07} & 2.81E-14 &1.37E-06&1.57E-14  &2.53E-14 &2.92E-04&{2.86E-04}& 100 & \textbf{16} & 1000 & 66   & 16     \\ 
Twisted   &2.15E-05& 1.07E-02 & 7.15E-04 & \textbf{5.89E-07} & 1.02E-02 & 4.52E-04 & \textbf{4.40E-05} & 4.80E-05 &5.36E-05&8.42E-05  &1.49E-04 &2.73E-05&\uline{5.70E-03}& 100 & \textbf{16} & 1000 & 49   & 16     \\ 
\end{tabular}
...
We next tested if the regularization improves the quality of the latent representation
without affecting the output accuracy. In \reftbl{tab:stability} (second columns)
we show the average Mean Square Error between the input and the output
...
harmed the accuracy because the network is already small and the further penalty for the compression
...
We compared the results between $\alpha=0.2,0.5,0.7$ and observed that they do not have
significantly different results:
They have similar reconstruction loss (MSE), similarly reduces the
effective bits, and similarly reduces the representation variance.
Therefore, we conclude that while ZSAE introduces an additional parameter,
the selection of $\alpha$ is easy compared to the selection of latent space size $N$.
We observe this from the fact that for the vanilla SAE with $N=36$ (Tuned parameter in \cite{Asai2018}),
the variance could be
up to two orders of magnitude smaller than the SAE with $N=100$.
