...
\begin{table}[tb]
 ...
 \caption{Results showing the total coverages of three runs on three
 uglified versions of the same set of domains. Each set contains all
 of benchmark domains and zerocost domains.}
