...
% 
\refig{f-h-eval} shows 
more fine-grained results by comparing the number of node evaluations
...
coverage 816.7$\pm$2.2) by $[h,\rd,\ro]$ and $[h,\ld,\ro]$, except in \pddl{Scanalyzer-analyse}
