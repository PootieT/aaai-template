...
% (left: training set, right: validation set).
 % 
Compared to SAE (green), we observed that ZSAE (gray) converges to
...
for aggressive hyperparameter tuning.  The ZSAE improves upon the
...
we reframed the underlying issue of this problematic behavior
as \emph{Symbol Stability Problem} (SSP), a subproblem of Symbol Grounding Problems (SGP)
which applies to any symbol grounding processes that contains stochasticity.
% 
