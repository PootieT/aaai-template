...
\begin{table}[tb]
 ...
 and $[h,\rd,\ro]$ with three seeds. Domains are the original set of
 domains and its three uglified versions. The effect
 of action ordering in the domain definition is small enough to be
