...
The stability of the representation and the \emph{robustness} against noisy data,
as is commonly listed as a virtue of the neural network, are orthogonal ideas.
This is because the latter cares solely about the accuracy for the training/validation data,
and while the former is a statement about the quality of the internal activation values of the network.
