...
\begin{figure}[htb]
 ...
 The runtime and memory usage difference were on average below a factor
 of x1.3 and x1.6 (shown in green line). We ignore the
 subsecond differences.}  \label{ffff}
\end{figure}
