...
All of these zerocost domains have large plateaus.
...
\begin{table}[tb]
 \centering
 \relsize{-2} % XXX \unfortunately, relsize{-3} was unreadable unless zoomed, so unusable for submission
...
We statistically analysed the results of $[h,\rd,\ro]$ 
