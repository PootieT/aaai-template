...
Let $p(b \mid x)$ and $q(x \mid b)$ be the encoder and the decoder of GS-VAE, respectively,
...
\end{align}
where $p^\star(b) = \prod_{n=1}^N p^\star(b_n) = \prod_{n=1}^N \mathrm{Bern}(0.5)$ is an $N$-dimensional Bernoulli distribution with uniform probabilities, 
