...
We first compared two strategies $[h,\fifo]$, $[h,\lifo]$, which
...
\begin{figure}[tb]
 ...
 \fifo second-level tie-breaking, with first-level $h$ tie-breaking.}  \label{f-h-eval}
\end{figure}
...
\begin{figure}[tb]
 ...
 labelled, colored variant. Both axes are logarithmic. Dotted lines represent
  $\times 10^n$ boundaries. We see many \pddl{Openstacks} and \pddl{Cybersec}
 instances near the $y=x$ line.}
  \label{plateau}
\end{figure}
