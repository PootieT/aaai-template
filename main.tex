...
\begin{table*}[tb]
 ...
 $\geq 2$. (Details for domains with $\mit{MaxDiff}<2$ are in the supplemental material,
 \reftbl{lmcut-ipc-full}, \reftbl{lmcut-zerocost-full}). The following domains had $\mit{MaxDiff}<2$:\\
 % 
