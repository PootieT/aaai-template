...
which is a technique that favors actions that decrease the
smallest $h$ value during the search. Although this was designed for non-admissible search in LAMA, preferred operators could, in principle, be applied to admissible search. However, in contrast to the tie-breaking strategies investigated in this paper, the selection of preferred operators  are specific to the heuri
