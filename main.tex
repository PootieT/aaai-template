...
tie-breaking, then $\depth{n} = 0$. Nodes with $\depth{n} = 0$ are called
...
tie-breaking criteria which we re-evaluated in the earlier sections and
...
\lifo, but instead by the second-level tie-breaking LastDepth.
...
original names of action schema are uglyfied randomly. This is because
