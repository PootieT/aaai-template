...
Autoencoders with $l_1$ regularization is called sparse autoencoder \cite{}.
From a practical point of view, as a Deep-Learning practice,
this is useful for training a wide network that has a larger latent space and smaller average activation.
