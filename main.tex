...
depth-first exploration will have non-decreasing $g$-values and non-increasing $h$-values.
...
FirstDepth is not shown due to space, but is mostly dominated by the RandomDepth and LastDepth, except in \pddl{Scanalyzer-analyse}
