...
on whether the network contains stochasticity during the runtime.
% 
...
% The purpose of Gumbel-Softmax VAE is to obtain a neural network
...
(All remaining notations follow \refsec{background}.)
