...
% 
The system gives a promising direction for performing symbolic reasoning in the real world.
In fact, it is later shown that the search space generated by \latentplanner are also compatible
to Goal Recognition framework \cite{amado2018goal}.
...
We computes the amount of memory reduction possible by the pruning on the nodes
that has a constant activation of 0. As we saw from \refig{tab:stability},
