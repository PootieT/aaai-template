...
\latentplanner uses a neural network
...
\emph{stable} when their referents (e.g. propositional values) do not change values against small perturbation of the observation,
