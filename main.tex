...
$h$-based tiebreaking (\refig{fig:plateau-noh} is the same figure
without this tiebreaking). Again, in this plot, $y$-axis shows the
number of nodes $f=f*, h=0$ and $x$-axis shows the total number of nodes
$f\leq f^*$. The size of the bucket does not change between
$[f,h,\fifo]$, $[f,h,\lifo]$ and $[f,h,\ro]$.

Clearly, in some domains, the planner cound spend most of the
