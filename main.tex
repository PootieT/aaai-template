...
$[\lifo]$, which simply breaks ties among nodes with the same $f$-cost by expanding most recently generated nodes first (first suggested in \cite{korf1985depth}), clearly dominates $[\fifo]$.
...
the non-paremetric Wilcoxon test.   % ``non-parametric'' means ``normal distribution not assumed
%Wilcoxon test,
