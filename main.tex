...
>>>>>>> variant B
problems.
We run experiments for both \lmcut and M\&S heuristics as $h$, but due to space limitation
we only show \lmcut results. The supplemental material contains M\&S.
####### Ancestor
problems
