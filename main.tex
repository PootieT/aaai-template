...
\end{tabular}
 ...
 Results are not shown when the SAE failed to converge (Mean square error between the input and the output larger than 0.01).
 }
\label{tab:stability}
\end{table*}
...
NN, which tries to minimize the number of true propositions
