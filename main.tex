...
\subsection{Tie-Breaking within depth-buckets} % changing from ``third-level'' because we'll also consider that sue depth as the 1st-level policy, e.g., [rd,random] (noh).
...
We evaluated five, three-level tie-breaking strategies and three 2-level
tie-breaking strategies in all. XXXTODOrecount!
