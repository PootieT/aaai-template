...
The \emph{entrance} to a $plateau(f_p,h_p)$ is the first node expanded with $f=f_p$ and $h=h_p$.
...
On the other hand, the breadth-first behavior of $[h,\fifo]$ results in spending too much time in the region close to the entrance of the plateau.
...
\begin{figure}[tb]
 ...
 \caption{Number of nodes ($y$-axis) in a particualr depth ($x$-axis) in
 the plateau.
 Each figure 
