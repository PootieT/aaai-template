...
\clearpage
\onecolumn
\section{Full Tables for \reftbl{depth} : Part 1/4, IPC domains, \lmcut}
...
\newpage
\section{Full Tables for \reftbl{depth} : Part 2/4, Zerocost domains, \lmcut}
...
\newpage
\section{Full Tables for \reftbl{depth} : Part 3/4, IPC domains, \mands}
...
\newpage
\section{Full Tables for \reftbl{depth} : Part 4/4, Zerocost domains, \mands}
