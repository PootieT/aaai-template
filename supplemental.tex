...
\clearpage
\onecolumn
\section{Untruncated Tables for \reftbl{depth} : Part 1, IPC domains, \lmcut}
...
\begin{table*}[htb]
 ...
 \caption{
 Untruncated version of the upper half of \reftbl{depth} showing 
...
\newpage
\section{Untruncated Tables for \reftbl{depth} : Part 2, Zerocost domains, \lmcut}
...
\newpage
\section{Untruncated Tables for \reftbl{depth} : Part 3, IPC domains, \mands}
...
\newpage
\section{Untruncated Tables for \reftbl{depth} : Part 4, Zerocost domains, \mands}
