...
\begin{itemize}
 ...
 \item Traditional knowledge engineering for planning and scheduling, as well as knowledge/feature engineering using Deep Learning techniques for Neural-Symbolic hybrid systems.
\end{itemize}
...
\begin{itemize}
 \item Alex Fukunaga (Assoc. Prof., The University of Tokyo)\\
       \url{fukunaga@idea.c.u-tokyo.ac.jp}\\
       Academic supervisor for the masters degree and the Ph.D degree.
 \item Akihiro Kishimoto (Research Staff Member, IBM Research Ireland)\\
       \url{AKIHIROK@ie.ibm.com}\\
       Supervisor during the internship at IBM Research Ireland in 2016 summer.
 \item Adi Botea (Researcher, IBM Research Ireland, former colleague)\\
       \url{ADIBOTEA@ie.ibm.com}\\
       Senior group member / coauthor during the internship at IBM Research Ireland.
\end{itemize}
...
\begin{figure}[h]
 \centering
 \includegraphics[width=0.8\linewidth]{img/mnist-plan.pdf}
 \includegraphics[width=0.8\linewidth]{img/mandrill-plan.pdf}
...
%  \centering
%  \includegraphics[width=0.8\linewidth]{img/mandrill-plan.pdf}
%  % \includegraphics[width=0.8\linewidth]{img/static/lenna.png}
%  \caption{More 8-puzzle result from \cite{Asai2017c}}
% \end{figure}

\begin{figure}[h]
 \centering
 \includegraphics[width=0.8\linewidth]{img/hanoi3.pdf}
 \includegraphics[width=0.8\linewidth]{img/hanoi4.pdf}
 \caption{The same system can solve Tower-of-Hanoi without any architectural change..}
\end{figure}

\begin{figure}[h]
 \centering
 \includegraphics[width=0.8\linewidth]{img/lights-out.pdf}
 \includegraphics[width=0.8\linewidth]{img/lights-out-skewed.pdf}
