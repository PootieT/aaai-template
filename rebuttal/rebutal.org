...
Finally, our finding of "Entropy Regularization" in Section 4
motivated us naturally to add a new regularization, Zero-suppression regularization.
...
might have given impression that we are hiding details.
...
Indeed, the supplemental section S2.3 linked just above
