...
\pdfinfo{
/Title ()
/Keywords (Planning, Heuristic Search, Knowledge Free Search)
}
...
\title{Knowledge Free Tiebreaking Strategy for Exploring the Final Plateau of Classical Planning}
\begin{document}
\maketitle
